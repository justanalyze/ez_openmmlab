...
from ez_openmmlab.core.inference import BaseData, Boxes, InferenceResult, Keypoints, Masks
...
def test_boxes_properties():
    ...
    data = np.array([[10, 20, 50, 60, 0.9, 0], [100, 200, 150, 260, 0.4, 1]])
...
def test_inference_result_container():
    ...
    res = InferenceResult(
        orig_img=img, path="test.jpg", names={0: "person"}, speed={"inference": 10.5}
    )
